---
title:  "<big><u>IMAP-WORKFLOWS</u></big><br><br>Microbial profiling using MOTHUR pipeline with Snakemake workflows<br><br>"
subtitle: |
...
A tentative snakemake workflow that defines **mothur and qiime2 bioinformatics rules** in a DAG (directed acyclic graph) format. 
A detailed interactive snakemake report is available [here](https://complexdatainsights.com/imap/imap-bioinformatics-mothur/report.html).


<br>

```{r child='workflow/scripts/01_mothur_pipeline.Rmd'}
```
...
| [IMAP-SUMMARY](https://github.com/tmbuza/imap-snakemake-workflows/) | Summary ofnakemake workflows for microbiome data analysis | [In-progress](https://tmbuza.github.io/imap-snakemake-workflows/) |
```
